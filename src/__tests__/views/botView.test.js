...
describe('BotView', () => {
  ...
  beforeEach(() => {
      ...
      wrapper2 = mount(<BotView player={player} targetPlayer="Malachi" clicked={callBack.bind(this)}/>)    
  })
  it('renders cards', () => {
    expect(wrapper2.find('.card-back').length).toEqual(5)
  });
